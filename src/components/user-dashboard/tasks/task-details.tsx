  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Task in{" "}
          <Link href={`/user-dashboard/projects/${task.project.id}`} className="hover:underline">
            {task.project.name}
          </Link>
        </CardDescription>
      </CardHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <div className={`text-xs ${daysRemaining < 0 ? "text-red-500 font-medium" : "text-muted-foreground"}`}>
                  {daysRemaining < 0
